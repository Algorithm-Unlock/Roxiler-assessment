...
The project is deployed and can be accessed at [https://github.com/Algorithm-Unlock/Roxiler-assessment/edit/main](https://github.com/Algorithm-Unlock/Roxiler-assessment/edit/main). You can use the following APIs to interact with the system.
